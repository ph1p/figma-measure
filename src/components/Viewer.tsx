  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {store.labels && (
          <rect x="38" y="85" width="3" height="14" fill={store.color} />
        )}
      </g>
      <g
        className="right-bar"
      ...
      >
        ...
        />
        {store.labels && (
          <rect x="143" y="85" width="3" height="14" fill={store.color} />
        )}
      </g>
      <g
        className="top-bar"
      ...
      <g className="tooltip">
        <path
          ...
          fill={store.surrounding.tooltip === 'right' ? store.color : '#E8ECFD'}
        />
        <path
          ...
          fill={
            store.surrounding.tooltip === 'bottom' ? store.color : '#E8ECFD'
          }
        />
        <path
          data-direction="left"
          ...
          fill={store.surrounding.tooltip === 'left' ? store.color : '#E8ECFD'}
        />
        <path
          data-direction="top"
          onClick={clickTooltip}
          ...
          fill={store.surrounding.tooltip === 'top' ? store.color : '#E8ECFD'}
        />
      </g>
    </svg>
  );
