...
export const fontName = async (node, parent, showFontSize, fontPattern) => {
  ...
  if (fontFamilyName) {
    ...
    const iconFrame = figma.createNodeFromSvg(
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M2 12L5.11111 4H6.19622L9.30733 12H8.23438L7.4566 10L3.85073 10L3.07296 12H2ZM5.65367 5.36389L7.06771 9L4.23962 9L5.65367 5.36389Z" fill="#8C8C8C"/>
      </svg>`,
    );
